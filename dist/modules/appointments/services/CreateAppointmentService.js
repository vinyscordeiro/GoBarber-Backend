...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if ((0, _dateFns.getHours)(appointmentDate) < 8 || (0, _dateFns.getHours)(appointmentDate) > 17) {
      throw new _AppError.default("You can't create appointments outside the available schedule");
    }
    ...
    const formatedDate = (0, _dateFns.format)(appointmentDate, "dd/MM/yyyy 'ás' HH:mm'h'");
